...
import { NorthwindModelCustomerDemographicUpdate } from "../components/schemas/NorthwindModelCustomerDemographicUpdate";
...
export type RequestBody = NorthwindModelCustomerDemographicUpdate;
